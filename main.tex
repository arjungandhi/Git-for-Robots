...
We now need to get the url for the repository this can be found by clicking the clone or download button on the page.

\begin{figure}[hp]
    \centering
    \includegraphics[width=4.5in]{images/clone.jpg}
\end{figure}
